...
export default function ProfessionalMeetingScheduler() {
  ...
  const calendarEvents = meetings.map(meeting => ({
    id: meeting._id,
    title: meeting.employeeId ? 
      `${meeting.employeeId.firstName} ${meeting.employeeId.lastName} - ${meeting.userId.firstName} ${meeting.userId.lastName}` :
    ...
    borderColor: meeting.status === "Demandé" ? 
      ...
      (theme === "dark" ? "#991b1b" : "#ef4444"),
    textColor: "#ffffff",
    editable: meeting.status === "Planifié"
  }));
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 border rounded-lg">
                  ...
                  {selectedMeeting.userId.phone && (
                    <div className="text-sm text-gray-600 dark:text-gray-300">{selectedMeeting.userId.phone}</div>
                  )}
                </div>
              </div>
